...
Order new_orders [N];		// array to be used for buffer
int num_new_orders = 0;		// count new orders
...
void* takeOrders(void* arg)
{
	...
	for(int i = 0; i < MAX; ++i) {
        ...
        // Put new order into new orders buffer and update orders
    	...
    	// Update order number for next number
    	++order_num;
